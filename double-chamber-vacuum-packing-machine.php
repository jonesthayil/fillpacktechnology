            ...
            <div class=row>
               <div class="col col-md-8 col-md-push-4">
                  <div class=service-single-content>
                     <div>
                        <img src=assets/images/product/BOTTLE-FILLING-MACHINE.jpg class=extraimg alt>
                     </div>
                     <div class=title>
                     ...
                     <div class=details>
                        <ul>
                           ...
                           <li><i class="fa fa-arrow-right"></i>Main motor 1 HP (Siemens, Hindustan, Bharat Bijlee).
                           </li>
                           <li><i class="fa fa-arrow-right"></i>Conveyor Motor ½ HP. (Siemens, Hindustan, Bharat
                              Bijlee).</li>
                        </ul>
                        <h4></h4>
                        <div class=extrabtn>
               ...
               <div class=row>
                  <div class="col col-md-4 col-sm-6">
                     <div class="widget about-widget">
                        <div class=footer-logo><img src=assets/images/fillpacklogo.png alt></div>
