            ...
            <div class="row products-grids">
               <div class="col col-md-4 col-xs-6">
                  <div class=grid>
                     ...
                     <div class=product-info>
                        <h3><a href=bottle-filling-machine.php>PP/Syrup Bottle Filling Machine</a></h3>
                        <div class=rating>
                        </div>
               ...
               <div class="col col-md-4 col-xs-6">
                  <div class=grid>
                     ...
                     <div class=product-info>
                        <h3><a href=/dairy/bottle-washing-machine.php>Bottle Washing Machine</a></h3>
                        <span class=price></span>
                     </div>
                  </div>
               </div>
               <div class="col col-md-4 col-xs-6">
                  <div class=grid>
                     ...
                     <div class=product-info>
                        <h3><a href=/dairy/automatic-auger-filler-with-screw-conveyor.php>Automatic Auger Filler Machine</a>
                        </h3>
                        <span class=price></span>
                     </div>
                  </div>
               ...
               <div class="col col-md-4 col-xs-6">
                  <div class=grid>
                     ...
                     <div class=product-info>
                        <h3><a href=/dairy/linear-conduction-sealing-machine.php>Conduction Sealing Machine</a></h3>
                        <span class=price></span>
                     </div>
                  </div>
               </div>
               <div class="col col-md-4 col-xs-6">
                  <div class=grid>
                     ...
                     <div class=product-info>
                        <h3><a href=tube-filling-machine.php>Tube Filling Machine</a></h3>
                        <span class=price></span>
                     </div>
                  </div>
               </div>
               <div class="col col-md-4 col-xs-6">
                  <div class=grid>
                     <div class=img-holder-info-list>
                        <div class=img-holder>
                           <img src="/assets/images/product/sealer.jpg" alt class="img img-responsive">
                        </div>
                     </div>
                     <div class=product-info>
                        <h3><a href=/dairy/web-sealing-machine.php>Web Sealer machine</a></h3>
                        <span class=price></span>
                     </div>
                  </div>
               </div>
