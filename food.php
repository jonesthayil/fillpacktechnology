            ...
            <div class="row products-grids">
               <div class="col col-md-4 col-xs-6">
                  <div class=grid>
                     ...
                     <div class=product-info>
                        <h3><a href=bottle-filling-machine.php>PP/Glass Bottle Filling Machine</a></h3>
               ...
               <div class="col col-md-4 col-xs-6">
                  <div class=grid>
                     ...
                     <div class=product-info>
                        <h3><a href=automatic-auger-filler-with-screw-conveyor.php>Automatic Auger Filler Machine </a>
                        </h3>
                        <span class=price></span>
                     </div>
                  </div>
               ...
               <div class="col col-md-4 col-xs-6">
                  <div class=grid>
                     ...
                     <div class=product-info>
                        <h3><a href=automatic-curd-cup-filling-and-sealing-machine.php>Automatic Cup Filling & Sealing
                              Machine</a></h3>
                        <span class=price></span>
                     </div>
                  </div>
               ...
               <div class="col col-md-4 col-xs-6">
                  <div class=grid>
                     ...
                     <div class=product-info>
                        <h3><a href=vacuum-packing-machine.php>Vacuum Packing Machine</a></h3>
                        <span class=price></span>
                     </div>
                  </div>
               </div>
               ...
               <div class="col col-md-4 col-xs-6">
                  <div class=grid>
                     ...
                     <div class=product-info>
                        <h3><a href=horizontal-flow-pack-packing-machine.php>Flow Wrap Machine</a></h3>
                        <span class=price></span>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="col col-md-4 col-sm-6">
                     <div class="widget about-widget">
                        ...
                        <ul class=contact-info>
                           The company has a successful leadership track record of two generations of being in the same
                           business of machine manufacturing, which once reckoned from machining job work 30 years back.
