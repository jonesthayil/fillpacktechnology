<?php
echo '<div class="topbar topbar-style-2">
   <div class=container>
      <div class=row>
            ...
            <div class=topbar-contact-info-wrapper>
               <div class=topbar-contact-info>
                  <div>
                     ...
                     <div class=details>
                        <p>Ekveera Laghu-Udyog Sankul, Unit No.14, Road No.25, Wagale Estate,Thane West-400604</p>
                     </div><br>
                  </div>
                  <div>
                     <i class="fa fa-phone"></i>
                     <p>(+91 ) 897 657 7735 / 998 778 4735
                        &emsp;
                        <i class="fa fa-envelope"></i>
                        export@fillpacktechnology.com / marketing@fillpacktechnology.com
                     </p>
                  </div>
               </div>
            </div>
         ...
         <div class="pull-right">
            <div class=social>
               ...
               <ul class=social-links>
                 ...
                 <li><a href="https://twitter.com/FillpackTechno1"><i class="fa fa-twitter"></i></a></li>
                 <li><a href="https://www.linkedin.com/in/fillpack-technology-923944199/"><i class="fa fa-linkedin"></i></a></li>
...
<div class="employee-of-month-grid">
      ...
      <div class=row>
         ...
         <div class="col col-sm-9">
            <div class=awards>
               ...
               <div>
                  <div class=icon><i class="fi flaticon-medal"></i>
                  </div>
                  <div class=award-info>
                     <h4>Winner</h4>
                     <p>Award 2016</p>
